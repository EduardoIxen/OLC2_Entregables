...
public class Parser extends java_cup.runtime.lr_parser {
 ...
 public final Class getSymbolContainer() {
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\010\000\006\004\007\005\005\001\002\000\010\002" +
    "\000\004\012\005\011\001\002\000\010\002\ufffc\004\ufffc" +
    "\005\ufffc\001\002\000\004\002\010\001\002\000\010\002" +
      ...
      switch (CUP$Parser$act_num)
		...
		RESULT = start_val;
          ...
          case 1: // S ::= L 
            {
              Object RESULT =null;
		 System.out.println("Salida: "+contadorUno+" veces 1 y "+contadorCero+" veces 0.");
